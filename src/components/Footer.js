        ...
        <div className="row" style={{marginRight:"0px !important"}}>
          ...
          <div className="col-md-6 offset-md-2 mb-3">
            <form style={{textAlign:'right'}}>
              ...
              <p style={{color: 'darkgrey'}}>movie-web does not host any files, it merely links to 3rd party services. Legal issues should be taken up with the file hosts and providers. movie-web is not responsible for any media files shown by the video providers.</p>
