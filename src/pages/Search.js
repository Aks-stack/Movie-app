...
export default function Search() {
    ...
    useEffect(() => {
        ...
        const res = await fetch(`https://api.themoviedb.org/3/search/movie?query=${Text}&include_adult=false&language=en-US&page=1&api_key=4e44d9029b1270a757cddc766a1bcb63`)
